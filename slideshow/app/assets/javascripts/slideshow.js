...
$(document).ready(function() {
    ...
    var sendRequest = function(request) {
      request.open("get", "json-slideshow.herokuapp.com//slide/" + currentSlide); //this is sending to the right page
      request.send();
  ...
  // Functions to get number of slides
    ...
    var sendNumRequest = function(request) {
      ...
      request.open("get", "https://json-slideshow.herokuapp.com//slide_num/"); //this is sending to the right page
      request.send();
